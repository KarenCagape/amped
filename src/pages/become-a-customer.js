        ...
        <Layout pageTitle={name}>
                        ...
                        <div tw="bg-sitegray p-12 text-center lg:text-left">
                            ...
                            >
                                <div tw="lg:grid lg:grid-cols-5">
                                    ...
                                    />
                                    <Button tw="col-span-2 lg:rounded-tl-none rounded-bl-none w-full lg:w-auto">SUBSCRIBE NOW</Button>
                                </div>
            ...
            <div tw="py-16 lg:py-48 overflow-x-hidden">
                ...
                <div tw="container px-4 mx-auto">
                    <div tw="grid grid-cols-1 lg:grid-cols-5">
                        <div tw="hidden lg:block text-px18 lg:text-2xl lg:text-px32 col-span-2"></div>
