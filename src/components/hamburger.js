...
export function Hamburger({ open, onClick }) {
  return (
    ...
    >
      ...
      >
        <div tw="h-0.5 bg-default rounded" />
        <div tw="h-0.5 bg-default rounded" />
        <div>
          <div tw="h-0.5 w-1/2 bg-default rounded" />
        </div>
      </div>
      <div
      ...
      >
        <div
          tw="h-0.5 w-10/12 bg-default rounded absolute -translate-y-1/2 -translate-x-1/2 rotate-45"
          css={[
            {
              left: '50%',
              top: '50%',
