...
export default function AmpedStoryMap({ images, ...rest }) {
    ...
    React.useEffect(() => {
        ...
        function repositionIndicator(dots) {
            ...
            const position = getPosition(rect.x + rect.width / 2, rect.y + rect.height / 2);
        ...
        const intervalId2 = setInterval(() => {
            ...
            if (showIndicator.current) {
                dotsIndicator.current.style.transform = "translate(-50%, -50%) scale(1.5)";
                return;
            }
    ...
    return (
        <div ref={parentRef} tw="relative">
            ...
            <div
                ...
                style={{ opacity: 0 }}
            >
                {images[currentDotIdx - 1] && images[currentDotIdx - 1]?.gatsbyImageData ? (
